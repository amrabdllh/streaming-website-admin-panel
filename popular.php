...
// Get all videos
$stmt = $pdo->prepare("SELECT * FROM videos ORDER BY views DESC");
$stmt->execute();
...
// Filter videos with random views > 100000
$popularVideos = [];
foreach ($allVideos as $video) {
    $randomViews = getRandomViews();
    if ($randomViews > 100000) {
        $video['random_views'] = $randomViews;
        $popularVideos[] = $video;
    }
}
                        ...
                        <?php foreach ($popularVideos as $video): ?>
                            <div class="video-card popular-card" 
                                ...
                                <div class="video-details">
                                    ...
                                    <p class="video-meta">
                                        <span class="views popular-views"><?php echo number_format($video['random_views']); ?> Views</span>
